...
<div class="search-area-wrapper">
    <div class="search-area container">
        ...
        <form id="search-form" class="search-form clearfix" method="post" action="servlet/SearchServlet" autocomplete="off">
            <input class="search-term required" style="height:50px;" type="text" id="keyword" name="keyword"
                   placeholder="请搜索你想要的菜" title="* Please enter a search term!"
    ...
    <table width="750" height="60" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td>
                ...
                <!-- 商品循环开始 -->
                <%
                    ArrayList<Dish> list = (ArrayList<Dish>)session.getAttribute("search_result");
